    ...
    <div class="p-4 sm:p-8 text-neutral-900 dark:text-neutral-100">
        <div class="max-full">
            <div class="flex justify-between items-center">
                <h1 class="text-2xl font-extrabold mb-6 border-b-4 border-yellow-400">Criar novo Género</h1>
            </div>
            ...
            <form method="POST" action="{{ route('genres.store') }}">
                ...
                <div class="flex mt-6">
                    <x-button element="submit" type="dark" text="Guardar novo Género" class="uppercase"/>
                </div>
            </form>
        </div>
    </div>
